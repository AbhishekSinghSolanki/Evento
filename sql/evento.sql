...
MySQL - 5.1.30-community : Database - evento
*********************************************************************
*/
...
insert  into `corpevent`(`S.no`,`name`,`email`,`services`,`package`,`message`) values (1,'Project Solaanki','abhi1996aug@yahoo.com','Conference','silver','hii');
...
insert  into `wedevent`(`S.no`,`name`,`email`,`services`,`package`,`message`) values (1,'Project Solaanki','abhi1996aug@yahoo.com','Seminar','platinum','hii');
